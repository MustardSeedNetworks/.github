...
# Shared from MustardSeedNetworks/.github, so the repo root cannot come from
# __file__. See I18N_REPO_ROOT in scripts/i18n/README.md.
ROOT = Path(os.environ.get("I18N_REPO_ROOT", ".")).resolve()
UI_SRC = ROOT / os.environ.get("UI_SRC_DIR", "ui/src")
LOCALES_EN = ROOT / os.environ.get("LOCALES_DIR", "internal/i18n/locales") / "en"
...
def main() -> int:
    ...
    repo_allowlist_path = ROOT / os.environ.get(
